...
export function Features() {
  return (
    <section id="features" className="relative py-32 bg-white overflow-hidden">
      <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-neutral-200/30 rounded-full blur-3xl -translate-y-1/2 translate-x-1/3" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          <Badge
            variant="outline"
            className="mb-6 border-neutral-300 text-neutral-600 bg-neutral-50/80"
          >
            What We Do
          </Badge>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((feature, i) => (
            ...
            >
              <Card className="h-full bg-white border-neutral-200 hover:border-brand-300/50 transition-all duration-300 hover:shadow-xl hover:shadow-brand-500/5 hover:-translate-y-1 group">
                <CardContent className="pt-2">
                  <div className="w-11 h-11 rounded-xl bg-neutral-100 group-hover:bg-brand-500/10 flex items-center justify-center mb-5 group-hover:scale-110 transition-all duration-300">
                    <feature.icon className="w-5 h-5 text-neutral-700 group-hover:text-brand-500 transition-colors" />
                  </div>
