...
export function Recruitment() {
  return (
    <section id="join" className="relative py-32 bg-neutral-900">
      <div
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="font-display font-bold text-4xl lg:text-5xl tracking-tight text-white mb-6">
            Dev-led.{" "}
        ...
        <div className="grid sm:grid-cols-2 gap-6 max-w-4xl mx-auto mb-12">
          {roles.map((role, i) => (
            ...
            >
              <Card className="h-full bg-neutral-800/50 backdrop-blur-sm border-neutral-700 hover:border-brand-300/50 transition-all duration-300 hover:shadow-lg hover:shadow-brand-500/5 group">
                <CardContent className="flex gap-5">
                  <div className="shrink-0 w-12 h-12 rounded-xl bg-neutral-800 group-hover:bg-brand-500/10 flex items-center justify-center transition-colors">
                    <role.icon className="w-6 h-6 text-neutral-400 group-hover:text-brand-500 transition-colors" />
                  </div>
                  <div>
        ...
        <motion.p
          className="text-center text-brand-400 font-medium leading-relaxed max-w-2xl mx-auto"
