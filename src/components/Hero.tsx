...
export function Hero() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      {/* Floating blobs */}
      <div className="absolute top-20 right-[15%] w-72 h-72 bg-brand-400/10 rounded-full blur-3xl animate-float" />
      <div
        className="absolute bottom-40 left-[10%] w-96 h-96 bg-neutral-300/20 rounded-full blur-3xl animate-float"
        style={{ animationDelay: "2s" }}
      />
      <div
        className="absolute top-1/3 left-[60%] w-48 h-48 bg-brand-300/10 rounded-full blur-2xl animate-float"
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 pt-24 pb-40 text-center">
        ...
        >
          <Badge
            variant="outline"
            className="mb-8 px-4 py-1.5 text-sm border-neutral-300 text-neutral-700 bg-white/80 backdrop-blur-sm"
          >
        ...
        >
          <span className="text-neutral-950">Maldives</span>
          <br />
        ...
        <motion.p
          className="max-w-2xl mx-auto text-lg sm:text-xl text-neutral-600 leading-relaxed mb-10 font-light"
          initial={{ opacity: 0, y: 30 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          ...
          <Button
            variant="outline"
            size="lg"
            className="border-neutral-300 text-neutral-700 hover:bg-neutral-50 hover:border-neutral-400 h-12 px-8 text-base"
            asChild
          >
